...
//	exprComp:expresion -> left:expresion  string:String  right:expresion

public class ExprComp extends AbstractExpresion {

	public ExprComp(Expresion left, String string, Expresion right) {
		this.left = left;
		this.string = string;
		this.right = right;
	...
	public ExprComp(Object left, Object string, Object right) {
