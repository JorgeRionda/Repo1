...
//	exprArit:expresion -> left:expresion  string:String  right:expresion

public class ExprArit extends AbstractExpresion {

	public ExprArit(Expresion left, String string, Expresion right) {
		this.left = left;
		this.string = string;
		this.right = right;
	...
	public ExprArit(Object left, Object string, Object right) {
