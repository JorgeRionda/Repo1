...
//	exprLlamadaFunc:expresion -> string:String  expresion:expresion*

public class ExprLlamadaFunc extends AbstractExpresion {

	public ExprLlamadaFunc(String string, List<Expresion> expresion) {
		this.string = string;
	...
	public ExprLlamadaFunc(Object string, Object expresion) {
